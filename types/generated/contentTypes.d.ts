...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    blog_category_definition: Attribute.Relation<
      'api::blog.blog',
      'oneToOne',
...
export interface ApiBlogCategoryBlogCategory extends Schema.SingleType {
...
export interface ApiBlogCategoryDefinitionBlogCategoryDefinition
  extends Schema.CollectionType {
  collectionName: 'blog_category_definitions';
  info: {
    singularName: 'blog-category-definition';
    pluralName: 'blog-category-definitions';
    displayName: 'Blog Category Definition';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiChannelChannel extends Schema.SingleType {
...
export interface ApiChannelDefinitionChannelDefinition
  extends Schema.CollectionType {
  collectionName: 'channel_definitions';
  info: {
    singularName: 'channel-definition';
    pluralName: 'channel-definitions';
  ...
  attributes: {
    saleChannel: Attribute.String;
    saleChannelID: Attribute.Integer;
    domainList: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::channel-definition.channel-definition',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiIslandIsland extends Schema.CollectionType {
  ...
  attributes: {
    ...
    layout: Attribute.DynamicZone<
      [
        'island-page.tour-detail-section',
        'home-page.tour-card',
        'shared.table',
        'shared.images',
        'shared.blog-card',
    ...
    subSaleChannel: Attribute.Enumeration<
      [
        'Samosa',
        'Rodosa',
        'Midilliye',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::blog-category-definition.blog-category-definition': ApiBlogCategoryDefinitionBlogCategoryDefinition;
      'api::channel.channel': ApiChannelChannel;
      'api::channel-definition.channel-definition': ApiChannelDefinitionChannelDefinition;
